...
public abstract class Decisionnaires {
    ...
    public Decisionnaires(final short x, final short y, final Grille grille, final Etat etat) {
        ...
        this.posX = x;
        this.posY = y;
        grille.setPosition(posX, posY, etat);
    }
    ...
    public boolean continuerSud() {
        return((getY() + 1) < Grille.getTailleY());
    }
    ...
    public boolean continuerEst() {
        return((getX() + 1 < Grille.getTailleX()));
    }
    ...
    public abstract boolean deplacer(final Grille grille, String direction); //direction uniquement pour le joueur, String quelconque pour les ia
}
